...
# 	poetry run kg merge -m duckdb -s "kg-microbe-core, hp, mondo, disbiome, ctd, wallen_etal, uniprot_human" --merge-label $@

# kg-microbe-biomedical-function:
# 	poetry run kg merge -m duckdb -s "bacdive, mediadive, madin_etal, rhea_mappings, bactotraits, chebi, ec, envo, go, ncbitaxon, upa, hp, mondo, disbiome, ctd, wallen_etal, uniprot_human, uniprot_functional_microbes" --merge-label $@
