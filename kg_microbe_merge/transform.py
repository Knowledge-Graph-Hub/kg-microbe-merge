...
from kg_microbe_merge.transform_utils.atc import ATCTransform
from kg_microbe_merge.transform_utils.ontology import OntologyTransform
from kg_microbe_merge.transform_utils.ontology.ontology_transform import ONTOLOGIES
...
def transform(
    ...
    Call scripts in kg_microbe_merge/transform/[source name]/ to
